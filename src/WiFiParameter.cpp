 ...
 * @Last Modified time: 2024-07-13 18:31:04
 */

#include "WiFiParameter.h"

WiFiParameter::WiFiParameter(const WiFiParameter &param)
{
    this->int_value = param.int_value;
    this->str_value = param.str_value;
    this->is_int = param.is_int;
    this->is_string = param.is_string;
    this->default_int = param.default_int;
    this->default_str = param.default_str;
    this->param = new WiFiManagerParameter(*param.param);
}
...
WiFiParameter::WiFiParameter(const char *id, const char *label, const char *defaultValue)
{
    this->default_int = 0;
    ...
    this->int_value = this->default_int;
    this->param = new WiFiManagerParameter(id, label, this->str_value.c_str(), this->str_value.length());
}

WiFiParameter::WiFiParameter(const char *id, const char *label, int defaultValue)
{
...
void WiFiParameter::set(const char *value)
{
    ...
    this->int_value = 0;
    this->param->setValue(this->str_value.c_str(), this->str_value.length());
}
